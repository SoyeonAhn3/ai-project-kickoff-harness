...
| 3 | `kickoff-checklist` SKILL.md 수정 (다음 단계 안내) | 🔲 | - |
| 4 | `profile-template.md` 수정 (섹션 8 플레이스홀더) | 🔲 | - |
| 5 | 포트폴리오 프로젝트 대상 테스트 (데모 기준 활성화) | 🔲 | - |
| 6 | 웹/앱 프로젝트 대상 테스트 (보안+운영 기준 활성화) | 🔲 | - |
